...
class Comic(models.Model):
    ...
    marvel_id = models.PositiveBigIntegerField(verbose_name='marvel_ids',
        default=1, unique=True)
    
    title = models.TextField(verbose_name='titles', max_length=120, 
        default='')
    
    description = models.TextField(verbose_name='descriptions', 
        default='')

    price = models.FloatField(verbose_name='prices', max_length=5, 
        default=0.00)

    stock_qty = models.PositiveIntegerField(verbose_name='stock_qty', 
        default=0)
...
class WishList(models.Model):
    ...
    cart = models.BooleanField(verbose_name='shopping_cart',
        default=None)

    wished_qty = models.PositiveIntegerField(verbose_name='wished_qty',
        default=0)

    buied_qty = models.PositiveIntegerField(verbose_name='buied_qty', 
        default=0)
